    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'ActivityDetail',
                component: () =>
                    import ('../views/front/ActivityDetail')
            },
            {
                path: 'MyCollection',
                name: 'MyCollection',
                component: () =>
                    import ('../views/front/MyCollection')
            },
            {
                path: 'MySubList',
                name: 'MySubList',
                component: () =>
                    import ('../views/front/MySubList')
            }
        ]
    }
]
            ...
            menus.forEach(item => {
                    if (item.path) {
                        let itemMenu = {
                            ...
                            name: item.name,
                            component: () =>
                                import ('../views/' + item.pagePath + '.vue')
                        }
